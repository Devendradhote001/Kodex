      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm">
          ...
          <div className="flex flex-col gap-4 text-sm">
            ...
            <div>
              <p>
                <span className="font-medium">Sarah Jenkins</span> onboarded for Product Team
              </p>
            ...
            <div>
              <p>
                Leave Request from <span className="font-medium">Marcus Aurelius</span> approved
              </p>
            ...
            <div>
              <p>
                <span className="font-medium">David Chen</span> completed 5 years anniversary
              </p>
